...
var DoublyNode = /*#__PURE__*/function (_Node) {
  inherits(DoublyNode, _Node);

  var _super = createSuper(DoublyNode);

  function DoublyNode(element, next, prev) {
    var _this;

    classCallCheck(this, DoublyNode);

    _this = _super.call(this, element, next);
    _this.prev = prev; // 指向上一个节点
...
var DoublyLinkedList = /*#__PURE__*/function (_LinkedList) {
  inherits(DoublyLinkedList, _LinkedList);

  var _super2 = createSuper(DoublyLinkedList);
  ...
  function DoublyLinkedList() {
    ...
    classCallCheck(this, DoublyLinkedList);

    _this2 = _super2.call(this, equalsFn);
    _this2.tail = undefined; // 记录双向链表最后一个节点
...
var Set = /*#__PURE__*/function () {
  ...
  createClass(Set, [{
    ...
    key: "size",
    value: function size() {
      return keys$3(this.items).length;
    }
    /**
     * 返回一个包含集合中所有元素的数组
     */
...
var ValuePair = /*#__PURE__*/function () {
  function ValuePair(key, value) {
    classCallCheck(this, ValuePair);

    this.key = key;
    this.value = value;
  }

  createClass(ValuePair, [{
    key: "toString",
    value: function toString() {
      var _context;
...
var HashMap = /*#__PURE__*/function () {
  ...
  createClass(HashMap, [{
    ...
    */
    ...
    key: "djb2HashCode",
    value: function djb2HashCode(key) {
    ...
    value: function verifyRemoveSideEffect(key, deletedPosition) {
      var hash = this.hashCode(key);
      var index = deletedPosition + 1;
    ...
    key: "size",
    value: function size() {
      return keys$3(this.table).length;
    }
    /**
     * 字典是否为空
     */
    ...
    value: function toString() {
      ...
      var keys = keys$3(this.table);

      var objString = concat$2(_context3 = "{".concat(keys[0], " => ")).call(_context3, this.table[keys[0]].toString(), "}");

      for (var i = 1; i < keys.length; i++) {
        var _context4, _context5;

        objString = concat$2(_context4 = concat$2(_context5 = "".concat(objString, ", {")).call(_context5, keys[i], " => ")).call(_context4, this.table[keys[i]].toString(), "}");
      }
...
var BinarySearchTree = /*#__PURE__*/function () {
  function BinarySearchTree() {
    ...
    classCallCheck(this, BinarySearchTree);
  ...
  createClass(BinarySearchTree, [{
    ...
    value: function removeNode(node, key) {
      ...
      var min = this.minNode(node.right);
      node.key = min.key;
...
var MinHead = /*#__PURE__*/function () {
  function MinHead() {
    var compareFn = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultCompare;

    classCallCheck(this, MinHead);
  ...
  createClass(MinHead, [{
    key: "_getLeftIndex",
    value: function _getLeftIndex(index) {
      return 2 * index + 1;
    }
    /**
     * 获取右侧子节点位置
    ...
    key: "_getRightIndex",
    value: function _getRightIndex(index) {
      return 2 * index + 2;
    }
    /**
     * 获取父节点位置
    ...
    key: "_getParentIndex",
    value: function _getParentIndex(index) {
      if (index === 0) {
        return undefined;
      }
    ...
    key: "_swap",
    value: function _swap(array, a, b) {
      var temp = array[a];
      array[a] = array[b];
      array[b] = temp;
    }
    ...
    key: "_shiftDown",
    value: function _shiftDown(index) {
      var element = index;
